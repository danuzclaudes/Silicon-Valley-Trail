...
public class Adventure {
    ...
    public void travel(City next_city){  	
    	...
    	// note: Day 13: You are 11 miles away from Washington, D.C.
    	//		should also print Day 14 since still requires one day to travel!!!
    	// note: current day number should also be updated!!!
