...
import a8.model.City;
import a8.model.InTransitException;
	...
	public void travelUpdate(Adventure adventure, 
		...
		try {
			...
			if(adventure.isTravelling()) {
				...
				tf.setText(adventure.getCurrentCity().getName()+" - Day "
						  +adventure.getDay());
			}
			...
			if (distance_to_destination == 0) {
				...
				update = "On day " + adventure.getDay() + 
						" you are " + distance_to_destination + 
						" miles from " + destination.getName()+"\n";
			}
			ta.append(update);
		} catch (InTransitException e) {
			System.out.println("Travelling.");
