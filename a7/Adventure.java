...
public class Adventure {
	...
	public Adventure(Difficulty mode, Squad squad){
		...
		// register Knapsack of Squad as TravelObserver
		this.addTravelObserver(squad.getKnapsack());
    ...
    public void travel(City next_city){  	
    	...
    	while(milesY>0){   		
    		...
    		// notify any registered observers about each day of traveling
    		for(TravelObserver o : observers){
    			o.travelUpdate(this, milesY, next_city);
    		}
    	}
